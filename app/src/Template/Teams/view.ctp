...
<div class="teams view large-10 medium-9 columns">
    ...
    <div class="row">
        <div class="large-5 columns strings">
            ...
            <p><?= $team->has('club') ? $this->Html->link($team->club->id, ['controller' => 'Clubs', 'action' => 'view', $team->club->id]) : '' ?></p>
        </div>
        <div class="large-2 columns numbers end">
            <h6 class="subheader"><?= __('Id') ?></h6>
            <p><?= $this->Number->format($team->id) ?></p>
            <h6 class="subheader"><?= __('Player Id') ?></h6>
            <p><?= $this->Number->format($team->player_id) ?></p>
        </div>
    </div>
</div>
