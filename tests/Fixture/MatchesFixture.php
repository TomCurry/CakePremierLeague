...
class MatchesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'home_team_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'away_team_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'matches_ibfk_1' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['matchdays', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
...
'engine' => 'InnoDB', 'collation' => 'utf8_general_ci'
    ...
    public $records = [
        [
            ...
            'stadium_id' => 1,
            'matchday_id' => 1,
            'created' => '2015-02-24 09:04:00',
            'updated' => '2015-02-24 09:04:00'
        ],
    ];
}
